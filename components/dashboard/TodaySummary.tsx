      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          <div className="rounded-md bg-gray-50 px-3 py-2 text-center">
            <div className="text-lg font-bold text-gray-500">{notArrivedCount}</div>
            <div className="text-xs text-gray-400">未来院</div>
          </div>
          <div className="rounded-md bg-blue-50 px-3 py-2 text-center">
            <div className="text-lg font-bold text-blue-600">{arrivedCount}</div>
            <div className="text-xs text-blue-500">来院済み</div>
          </div>
          <div className="rounded-md bg-green-50 px-3 py-2 text-center">
            <div className="text-lg font-bold text-green-600">{inProgressCount}</div>
            <div className="text-xs text-green-500">診療中</div>
          </div>
          <div className="rounded-md bg-gray-50 px-3 py-2 text-center">
            <div className="text-lg font-bold text-gray-400">{completedCount}</div>
            <div className="text-xs text-gray-400">帰宅済み</div>
          </div>
        </div>

        {cancelledCount > 0 && (
          <div className="mb-4 rounded-md bg-red-50 px-3 py-2 text-center">
        ...
        <div className="mb-4 rounded-md border border-gray-200 px-3 py-2">
          <div className="text-xs text-gray-500">現在の空きユニット</div>
          <div className="text-lg font-bold text-gray-900">
            {availableUnits} <span className="text-sm font-normal text-gray-400">/ {unitCount}</span>
          </div>
        </div>
        ...
        {nextAppointment && (
          <div className="rounded-md border border-blue-200 bg-blue-50 px-3 py-2">
            ...
            <div className="text-xs text-blue-700">
              ...
              {' '}ユニット{nextAppointment.unit_number}
            </div>
          </div>
        )}
      </div>
